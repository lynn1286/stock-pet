    ...
    <div className="s-summary">
      ...
      <div className="s-summary-metrics">
        <div className="s-metric">
          ...
          <span className={`s-metric-value ${summary.totalProfit > 0 ? 's-profit-up' : summary.totalProfit < 0 ? 's-profit-down' : ''}`}>
            {fmtProfit(summary.totalProfit)}
          </span>
          <span className={`s-metric-pct ${summary.totalProfitPct > 0 ? 's-profit-up' : summary.totalProfitPct < 0 ? 's-profit-down' : ''}`}>
        ...
        <div className="s-metric">
          ...
          <span className={`s-metric-value ${summary.totalDailyProfit > 0 ? 's-profit-up' : summary.totalDailyProfit < 0 ? 's-profit-down' : ''}`}>
            {fmtProfit(summary.totalDailyProfit)}
          </span>
          <span className={`s-metric-pct ${summary.totalDailyPct > 0 ? 's-profit-up' : summary.totalDailyPct < 0 ? 's-profit-down' : ''}`}>
